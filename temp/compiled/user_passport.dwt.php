...
<div class="user_shuomin"> 即日起注册会员就送积分，可换精美礼品。详情请见 <a href="#">注册会员有礼活动</a> </div>
<div class="blank"></div>
<div class="blank"></div>
  ...
  <div class="user_tit">会员登录</div>

   <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
          <tr>
            <td width="15%" align="right"><?php echo $this->_var['lang']['label_username']; ?></td>
            <td width="85%"><input style="width:200px;" name="username" type="text" size="25" class="inputBg" /></td>
          </tr>
          <tr>
            <td align="right"><?php echo $this->_var['lang']['label_password']; ?></td>
            <td>
            <input style="width:200px;" name="password" type="password" size="15"  class="inputBg"/>
            </td>
          </tr>
	  ...
	  <tr><td></td><td><a href="user.php?act=qpassword_name"><?php echo $this->_var['lang']['get_password_by_question']; ?></a>&nbsp;&nbsp;&nbsp;<a href="user.php?act=get_password" ><?php echo $this->_var['lang']['get_password_by_mail']; ?></a></td></tr>
      </table>
    </form>
    <div class="blank"></div>
  </div>
  ...
  <div class="user_tit">会员注册</div>
  <div style="padding-left:50px; line-height:23px;">
    ...
    <a href="user.php?act=register"><img src="themes/quwan/images/bnt_ur_reg.gif" /></a>
  </div>
   </div>
</div>
<?php endif; ?>
