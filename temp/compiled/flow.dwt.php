...
<div class="block">
  <?php if ($this->_var['step'] == "cart"): ?>
    <img src="themes/quwan/images/step_1.gif" />
...
<form id="formCart" name="formCart" method="post" action="flow.php">
           <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0">
            <tr>
              <th bgcolor="#f1edec"><?php echo $this->_var['lang']['goods_name']; ?></th>
      <?php if ($this->_var['show_goods_attribute'] == 1): ?>
              <th bgcolor="#f1edec">度数</th>
              <?php endif; ?>
              <?php if ($this->_var['show_marketprice']): ?>
              <th bgcolor="#f1edec"><?php echo $this->_var['lang']['market_prices']; ?></th>
              <?php endif; ?>
              <th bgcolor="#f1edec"><?php echo $this->_var['lang']['shop_prices']; ?></th>
              <th bgcolor="#f1edec"><?php echo $this->_var['lang']['number']; ?></th>
              <th bgcolor="#f1edec"><?php echo $this->_var['lang']['subtotal']; ?></th>
              <th bgcolor="#f1edec"><?php echo $this->_var['lang']['handle']; ?></th>
            </tr>
...
?>
            ...
            <tr>
              <td colspan="7" align="center" bgcolor="#ffffff" style="border-bottom:1px dotted #ccc">&nbsp;
...
<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            <td bgcolor="#ffffff"><a href="./"><img src="themes/quwan/images/continue.gif" alt="continue" /></a></td>
            <td bgcolor="#ffffff" align="right"><a href="flow.php?step=checkout"><img src="themes/quwan/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
...
?>
            <ul class="clearfix">
              ...
              <li>
                ...
                <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/quwan/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a>
              </li>
            </ul>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/quwan/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
  ...
  <?php endif; ?>
        ...
        <img src="themes/quwan/images/step_2.gif" />
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/quwan/images/bnt_subOrder.gif" />
        ...
        <?php if ($this->_var['step'] == "done"): ?>
            ...
            <img src="themes/quwan/images/step_3.gif" />
        <div class="flowBox flowBox1" style="margin:0 auto 70px auto;">
         <h6 style="text-align:center; height:30px; line-height:30px;"><?php echo $this->_var['lang']['remember_order_number']; ?>: <font style="color:red"><?php echo $this->_var['order']['order_sn']; ?></font></h6>
          <table width="100%" align="center" border="0" cellpadding="15" cellspacing="0" bgcolor="#fff" >
           <tr>
              <td align="center" bgcolor="#FFFFFF">
            <img style="border:none" src="themes/quwan/images/chengong.gif" />
              </td>
            </tr>
            <tr>
              <td align="center" bgcolor="#FFFFFF">
