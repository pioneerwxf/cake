...
?>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><label for="outstock"><?php if ($this->_var['outstock']): ?>checked="checked"<?php endif; ?>/> <?php echo $this->_var['lang']['hidden_outstock']; ?><?php if ($this->_var['outstock']): ?>checked="checked"<?php endif; ?>/> <?php echo $this->_var['lang']['hidden_outstock']; ?><input type="checkbox" name="outstock" value="1" id="outstock" <?php if ($this->_var['outstock']): ?>checked="checked"<?php endif; ?>/> <?php echo $this->_var['lang']['hidden_outstock']; ?></label>
        </td>
      </tr>
      <?php endif; ?>
         ...
         <?php endif; ?>
          ...
          &nbsp;&nbsp;&nbsp;
              ...
              <?php echo $this->html_options(array('options'=>$this->_var['lang']['order'],'selected'=>$this->_var['pager']['search']['order'])); ?>
                ...
                <input style="position:relative; top:0px;" type="image" name="imageField" src="themes/quwan/images/bnt_search.gif" alt="go"/>
...
?>
    ...
    <font class="f1"><?php echo $this->_var['lang']['promote_price']; ?> <?php echo $this->_var['goods']['promote_price']; ?></font> 
    <?php else: ?>
    <font class="f1">本店价：<?php echo $this->_var['goods']['shop_price']; ?></font> 
    <?php endif; ?>
    &nbsp;
     <?php if ($this->_var['show_marketprice']): ?>
    <span style="color:#999"><?php echo $this->_var['lang']['market_price']; ?><font class="market_s"><?php echo $this->_var['goods']['market_price']; ?></font> </span>
    <?php endif; ?>
    </p>
    
     <?php if ($this->_var['goods']['goods_brief']): ?>
   <p class="tese">
   产品特色：<b><?php echo $this->_var['goods']['goods_brief']; ?></b>
   </p>
    <?php endif; ?> 
    <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/quwan/images/goumai.gif"></a>
    <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);"><img src="themes/quwan/images/shoucang.gif"></a>
    <a href="javascript:;" id="compareLink" onClick="Compare.add(<?php echo $this->_var['goods']['goods_id']; ?>,'<?php echo addslashes($this->_var['goods']['goods_name']); ?>','<?php echo $this->_var['goods']['type']; ?>')"><img src="themes/quwan/images/duibi.gif"></a> 
...
?>
   ...
   <?php if ($this->_var['goods']['promote_price'] != ""): ?>
    ...
    <?php else: ?>
    <font class="shop">本店价：<?php echo $this->_var['goods']['shop_price']; ?></font> 
    <?php endif; ?>
